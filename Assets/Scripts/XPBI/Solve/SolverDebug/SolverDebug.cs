...
namespace GPU.Solver {
    internal sealed partial class SolverDebug {
        ...
        public void PrepareSession(SolveSession session) {
            ...
            session.ColoringUpdatedByLayer = session.Request.ConvergenceDebugEnabled ? new bool[session.ConvergenceDebugLayerCount] : null;
        ...
        public void RecordReadbacksAndFence(SolveSession session, GraphicsFence fence) {
            ...
            if (session.Request.ConvergenceDebugEnabled && convergenceDebug != null && convergenceDebugRequiredUInts > 0) {
                Graphics.WaitOnAsyncGraphicsFence(fence);
