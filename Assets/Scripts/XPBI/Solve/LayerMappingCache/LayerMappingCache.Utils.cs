...
namespace GPU.Solver {
    internal sealed partial class LayerMappingCache {
        ...
        internal void BindDtGlobalMappingParams(int kernel, bool useDtGlobalNodeMap, int dtLocalBase, ComputeBuffer dtGlobalNodeMap, ComputeBuffer dtGlobalToLayerLocalMap) {
            solver.asyncCb.SetComputeIntParam(solver.shader, "_UseDtGlobalNodeMap", useDtGlobalNodeMap ? 1 : 0);
            solver.asyncCb.SetComputeIntParam(solver.shader, "_DtLocalBase", dtLocalBase);

            solver.asyncCb.SetComputeBufferParam(solver.shader, kernel, "_DtGlobalNodeMap", dtGlobalNodeMap ?? defaultDtGlobalNodeMap);
            solver.asyncCb.SetComputeBufferParam(solver.shader, kernel, "_DtGlobalToLayerLocalMap", dtGlobalToLayerLocalMap ?? defaultDtGlobalToLocalMap);
        }
    }
}
