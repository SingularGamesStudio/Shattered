#ifndef XPBI_LAYER_ACTUAL_SOLVE_RELAX_NON_PARALLEL_INCLUDED
#define XPBI_LAYER_ACTUAL_SOLVE_RELAX_NON_PARALLEL_INCLUDED
...
void RelaxColoredPersistentCoarse(uint3 gtid : SV_GroupThreadID)
{
    ...
    [loop]
    for (uint iter = 0u; iter < _PersistentIters; iter++)
    {
...
#endif // XPBI_LAYER_ACTUAL_SOLVE_RELAX_NON_PARALLEL_INCLUDED